(function (b) {
  var a = function (i, f) {
    var j = location.host, h = j.replace(/[\-.:]/g, "") + "kakaopayLibrary_LOG", d, g, l;
  ...
  var c = function () {
    var d = b.kakaopayDlpConfig;
    b.kakaopayDlpConfig = null;
    var e = {};
    var f = {};
    ...
    d.initLayer = function (v) {
      ...
      if (!m) {
        ...
        s.css({"z-index": this.zIndex, position: q, width: h, height: u, left: n, top: t});
        s.attr("tabindex", 0)
      }
      s.show();
      return s
      ...
      try {
        ...
        var l = new easyXDM.Rpc({
          ...
          onReady: function () {
            ...
            $("#easyXDM_dlp_provider").css({width: d.layerConfig[m].width, height: d.layerConfig[m].height});
            if (d.prType === "MPM") {
          ...
          remote: {initDlp: {}, getAuthInfo: {}, closeServerDlp: {}, callApp: {}},
          local: {
  ...
  if (typeof b.kakaopayDlp === "undefined") {
    b.kakaopayDlp = new c()
  }
})(window);